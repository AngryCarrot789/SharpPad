...
namespace SharpPad.CommandSystem {
    ...
    public class CommandManager {
        ...
        public async Task<bool> TryExecute(string commandId, Func<IContextData> contextProvider, bool isUserInitiated = true) {
            ...
            await Command.InternalExecuteUser(commandId, command.Command, new CommandEventArgs(this, context, isUserInitiated));
            return true;
        }
        ...
        public Task Execute(string cmdId, Command cmd, IContextData context, bool isUserInitiated = true) {
            ...
            return Command.InternalExecuteUser(cmdId, cmd, new CommandEventArgs(this, context, isUserInitiated));
        }
        ...
        public Task Execute(Command cmd, IContextData context, bool isUserInitiated = true) {
            ValidateContext(context);
            return Command.InternalExecuteUser(null, cmd, new CommandEventArgs(this, context, isUserInitiated));
        }
        ...
        /// <exception cref="ArgumentException">ID is null, empty or consists of only whitespaces</exception>
        /// <exception cref="ArgumentNullException">Context is null</exception>
        public Executability CanExecute(string id, IContextData context, bool isUserInitiated = true) {
            ValidateId(id);
            ValidateContext(context);
