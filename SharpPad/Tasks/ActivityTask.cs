...
namespace SharpPad.Tasks {
    ...
    public class ActivityTask {
        ...
        private async Task TaskMain() {
            ...
            try {
                await TaskManager.InternalBeginActivateTask_BGT(this.taskManager, this);
                this.CheckCancelled();
        ...
        private Task OnCancelled() => TaskManager.InternalOnTaskCompleted_BGT(this.taskManager, this, 3);
        ...
        private async Task OnCompleted(Exception e) {
            ...
            await TaskManager.InternalOnTaskCompleted_BGT(this.taskManager, this, 2);
        }
