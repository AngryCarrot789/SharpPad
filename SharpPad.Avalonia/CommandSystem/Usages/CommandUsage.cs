...
namespace SharpPad.Avalonia.CommandSystem.Usages;
...
public abstract class CommandUsage
{
    ...
    {
        RapidDispatchAction guard = this.delayedContextUpdate ??= new RapidDispatchAction(this.UpdateCanExecute, DispatcherPriority.Loaded, "UpdateCanExecute");
        guard.InvokeAsync();
    }
