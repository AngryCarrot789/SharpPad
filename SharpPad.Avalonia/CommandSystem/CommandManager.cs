...
namespace SharpPad.Avalonia.CommandSystem;
...
public class CommandManager
{
    ...
    public CommandManager()
    {
        ...
        this.focusChangeRaiserRda = new RapidDispatchAction<Func<IContextData>>(this.OnFocusChange, DispatcherPriority.Background);
    }
