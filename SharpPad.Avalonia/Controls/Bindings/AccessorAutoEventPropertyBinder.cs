...
public class AccessorAutoEventPropertyBinder<TModel, TValue> : BaseBinder<TModel> where TModel : class
{
    ...
    public AccessorAutoEventPropertyBinder(AvaloniaProperty<TValue> property, string eventName, ValueAccessor<TValue> accessor)
    {
    ...
    protected override void OnAttached()
    {
        ...
        if (this.Property != null)
            this.propChangeHandler = this.Property.Changed.AddClassHandler<AvaloniaObject, TValue>(this.OnPropertyChanged);
    }
    ...
    private void OnPropertyChanged(AvaloniaObject sender, AvaloniaPropertyChangedEventArgs<TValue> e)
    {
