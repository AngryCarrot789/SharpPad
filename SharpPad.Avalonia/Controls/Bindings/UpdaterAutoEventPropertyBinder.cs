...
public class UpdaterAutoEventPropertyBinder<TModel> : UpdaterPropertyBinder<TModel> where TModel : class
{
    ...
    public UpdaterAutoEventPropertyBinder(AvaloniaProperty property, string eventName, Action<IBinder<TModel>> updateControl, Action<IBinder<TModel>> updateModel) : base(property, updateControl, updateModel)
    {
