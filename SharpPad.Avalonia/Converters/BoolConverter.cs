...
{
    public new IBrush? TrueValue
    {
        get => (IBrush?) base.TrueValue;
        set => base.TrueValue = value;
    }

    public new IBrush? FalseValue
    {
        get => (IBrush?) base.FalseValue;
...
public class BoolToColourConverter : BoolConverter
{
    ...
    {
        get => (Color) (base.TrueValue ?? default(Color));
        set => base.TrueValue = value;
    }

    public new Color FalseValue
    {
        get => (Color) (base.FalseValue ?? default(Color));
        set => base.FalseValue = value;
    }
...
public class BoolToDoubleConverter : BoolConverter
{
    ...
    {
        get => (double) (base.TrueValue ?? 0.0);
        set => base.TrueValue = value;
    }

    public new double FalseValue
    {
        get => (double) (base.FalseValue ?? 0.0);
        set => base.FalseValue = value;
    }
