...
public static class IoC
{
    ...
    /// </summary>
    public static Dispatcher Dispatcher => ApplicationCore.Instance.Dispatcher;
    ...
    public static Thread DispatcherThread => ApplicationCore.Instance.DispatcherThread;
}