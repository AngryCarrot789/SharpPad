...
public abstract class RapidDispatchActionBase
{
    ...
    protected RapidDispatchActionBase(DispatcherPriority priority, string debugId = null)
    {
    ...
    protected bool BeginInvoke()
    {
        ...
        Dispatcher.UIThread.InvokeAsync(this.doExecuteCallback, this.Priority);
        return true;
    }
...
public class RapidDispatchAction : RapidDispatchActionBase, IDispatchAction
{
    ...
    public RapidDispatchAction(Action callback, string debugId = null) : this(callback, DispatcherPriority.Normal, debugId)
    {
    }

    public RapidDispatchAction(Action callback, DispatcherPriority priority, string debugId = null) : base(priority, debugId)
    {
...
public class RapidDispatchAction<T> : RapidDispatchActionBase, IDispatchAction<T>
{
    ...
    public RapidDispatchAction(Action<T> callback, string debugId = null) : this(callback, DispatcherPriority.Normal, debugId)
    {
    }

    public RapidDispatchAction(Action<T> callback, DispatcherPriority priority, string debugId = null) : base(priority, debugId)
    {
