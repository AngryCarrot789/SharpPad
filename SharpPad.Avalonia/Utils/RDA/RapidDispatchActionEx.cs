...
namespace SharpPad.Avalonia.Utils.RDA;
...
public sealed class RapidDispatchActionEx : RapidDispatchActionExBase, IDispatchAction
{
    ...
    public static RapidDispatchActionEx ForSync(Action callback, string debugId = null) =>
        ForSync(callback, DispatcherPriority.Normal, debugId);

    public static RapidDispatchActionEx ForSync(Action callback, DispatcherPriority priority, string debugId = null) =>
        ForSync(callback, Dispatcher.UIThread, priority, debugId);

    public static RapidDispatchActionEx ForSync(Action callback, Dispatcher dispatcher, string debugId = null) =>
        ForSync(callback, dispatcher, DispatcherPriority.Normal, debugId);

    /// <summary>
    /// Creates an instance of <see cref="RapidDispatchActionEx"/> that runs a non-async callback
    /// </summary>
    public static RapidDispatchActionEx ForSync(Action callback, Dispatcher dispatcher, DispatcherPriority priority, string debugId = null)
    {
    ...
    public static RapidDispatchActionEx ForAsync(Func<Task> callback, string debugId = null) =>
        ForAsync(callback, DispatcherPriority.Normal, debugId);

    public static RapidDispatchActionEx ForAsync(Func<Task> callback, DispatcherPriority priority, string debugId = null) =>
        ForAsync(callback, Dispatcher.UIThread, priority, debugId);

    public static RapidDispatchActionEx ForAsync(Func<Task> callback, Dispatcher dispatcher, string debugId = null) =>
        ForAsync(callback, dispatcher, DispatcherPriority.Normal, debugId);

    /// <summary>
    /// Creates an instance of <see cref="RapidDispatchActionEx"/> that runs an async callback
    /// </summary>
    public static RapidDispatchActionEx ForAsync(Func<Task> callback, Dispatcher dispatcher, DispatcherPriority priority, string debugId = null)
    {
        Validate.NotNull(callback, nameof(callback));
        Validate.NotNull(dispatcher, nameof(dispatcher));
...
public sealed class RapidDispatchActionEx<T> : RapidDispatchActionExBase, IDispatchAction<T>
{
    ...
    public static RapidDispatchActionEx<T> ForSync(Action<T> callback, DispatcherPriority priority, string debugId = null)
    {
        return ForSync(callback, Dispatcher.UIThread, priority, debugId);
    }

    /// <summary>
    /// Creates an instance of <see cref="RapidDispatchActionEx"/> that runs a non-async callback
    /// </summary>
    public static RapidDispatchActionEx<T> ForSync(Action<T> callback, Dispatcher dispatcher, DispatcherPriority priority, string debugId = null)
    {
        Validate.NotNull(callback, nameof(callback));
        Validate.NotNull(dispatcher, nameof(dispatcher));
    ...
    /// Creates an instance of <see cref="RapidDispatchActionEx"/> that runs an async callback
    /// </summary>
    public static RapidDispatchActionEx<T> ForAsync(Func<T, Task> callback, DispatcherPriority priority, string debugId = null)
    {
        return ForAsync(callback, Dispatcher.UIThread, priority, debugId);
    }

    /// <summary>
    /// Creates an instance of <see cref="RapidDispatchActionEx"/> that runs an async callback
    /// </summary>
    public static RapidDispatchActionEx<T> ForAsync(Func<T, Task> callback, Dispatcher dispatcher, DispatcherPriority priority, string debugId = null)
    {
        Validate.NotNull(callback, nameof(callback));
        Validate.NotNull(dispatcher, nameof(dispatcher));
